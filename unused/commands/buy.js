...
module.exports = {
	...
	execute(message, args) {
        ...
        let locations = JSON.parse(fs.readFileSync('databases/locations.json'))
        let objects = JSON.parse(fs.readFileSync('databases/objects.json'))
        let limitations = JSON.parse(fs.readFileSync('databases/limitations.json'))
        let shop = JSON.parse(fs.readFileSync('shop.json'))
        let religions = JSON.parse(fs.readFileSync('databases/religions.json'))
        ...
        // Overwrite JSON file
            ...
            fs.writeFileSync('databases/limitations.json', JSON.stringify(limitations))
